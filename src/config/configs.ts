...
export const configs = {
  ...
  ACTIONS_FORGOT_PASSWORD_SECRET: process.env.ACTIONS_FORGOT_PASSWORD_SECRET,
  ACTIONS_FORGOT_PASSWORD_EXPIRATION:
    process.env.ACTIONS_FORGOT_PASSWORD_EXPIRATION,
